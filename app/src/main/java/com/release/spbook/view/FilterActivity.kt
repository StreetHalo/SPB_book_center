...
class FilterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filter_publ_your_book.setOnClickListener {
            filter_publ_your_book.isChecked = !filter_publ_your_book.isChecked
        }

        filter_publ_store.setOnClickListener {
            filter_publ_store.isChecked = !filter_publ_store.isChecked
        }

        filter_publ_online_store.setOnClickListener {
